...
type OTPInputContextType = {
  ...
  // Add other properties if needed from the actual context
};
...
>(({ index, className, ...props }, ref) => {
  const inputOTPContext = React.useContext(OTPInputContext) as OTPInputContextType; // Cast to defined type
