...
import { getAppCheck } from 'firebase/app'; // Corrected: getAppCheck is from firebase/app
import { getToken as getAppCheckToken } from 'firebase/app-check'; // getToken is still from firebase/app-check
