...
import { getAppCheck } from 'firebase/app-check'; // Corrected: getAppCheck is from firebase/app-check
import { getToken as getAppCheckToken } from '@firebase/app-check'; // getToken is from @firebase/app-check
