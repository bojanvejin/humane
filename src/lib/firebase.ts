...
import { getAnalytics, isSupported } from 'firebase/analytics'; // Import for analytics
...
const firebaseConfig = {
  ...
  measurementId: process.env.NEXT_PUBLIC_FIREBASE_MEASUREMENT_ID, // Include measurementId for analytics
};
